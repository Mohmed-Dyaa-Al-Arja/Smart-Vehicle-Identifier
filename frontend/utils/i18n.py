...
TRANSLATIONS = {
    "en": {
        ...
        "chat_like": "Like",
        "chat_more": "More",
        "chat_online": "AI VEHICLE ASSISTANT",
        "chat_hero_desc": "Ask questions about vehicles, compare models, explore specifications, prices and more.",
        "chat_tag_specs": "Specifications",
        "chat_tag_compare": "Comparisons",
        "chat_tag_prices": "Prices",
        "chat_welcome_title": "How can I help you today?",
        "chat_ready": "Ready to answer your questions",
        "chat_input_note": "AI responses may contain mistakes. Please verify important information.",
        "chat_new_chat": "New Chat",
        "chat_unknown_vehicle": "Unknown vehicle",
        "chat_no_vehicle": "No vehicle detected",
        "chat_no_vehicle_desc": "Detect a vehicle first to get personalized answers.",
        "chat_suggested_desc": "Quick questions to explore vehicle information.",
        "chat_ai_model": "AI Model",
        "chat_ai_model_desc": "Powered by Vehicle Vision AI for intelligent vehicle analysis.",
        "chat_model_ready": "Model ready",
        "chat_recent_vehicle": "Recent Vehicle",
        "chat_recent_empty": "Your detected vehicle will appear here.",
    ...
    "ar": {
        ...
        # New Chat UI
        "chat_you": "أنت",
        "chat_ai_assistant": "المساعد الذكي",
        "chat_copy": "نسخ",
        "chat_like": "إعجاب",
        "chat_more": "المزيد",
        "chat_online": "مساعد المركبات الذكي",
        "chat_hero_desc": "اسأل عن المركبات، قارن بين الموديلات، واستكشف المواصفات والأسعار والمزيد.",
        "chat_tag_specs": "المواصفات",
        "chat_tag_compare": "المقارنات",
        "chat_tag_prices": "الأسعار",
        "chat_welcome_title": "كيف يمكنني مساعدتك اليوم؟",
        "chat_ready": "جاهز للإجابة على أسئلتك",
        "chat_input_note": "قد تحتوي إجابات الذكاء الاصطناعي على أخطاء. يُرجى التحقق من المعلومات المهمة.",
        "chat_new_chat": "محادثة جديدة",
        "chat_unknown_vehicle": "مركبة غير معروفة",
        "chat_no_vehicle": "لم يتم اكتشاف مركبة",
        "chat_no_vehicle_desc": "قم بكشف مركبة أولاً للحصول على إجابات مخصصة.",
        "chat_suggested_desc": "أسئلة سريعة لاستكشاف معلومات المركبات.",
        "chat_ai_model": "نموذج الذكاء الاصطناعي",
        "chat_ai_model_desc": "مدعوم بواسطة Vehicle Vision AI لتحليل المركبات بذكاء.",
        "chat_model_ready": "النموذج جاهز",
        "chat_recent_vehicle": "آخر مركبة",
        "chat_recent_empty": "ستظهر المركبة التي تم اكتشافها هنا.",
